...
#define GRENADELAUNCHER_ATTACHMENT_LAST_PART 0
#define GRENADELAUNCHER_ATTACHMENT_MAIN_PART 1
#define GRENADELAUNCHER_ATTACHMENT_SECOND_PART 2
#define GRENADELAUNCHER_ATTACHMENT_THIRD_PART 4
