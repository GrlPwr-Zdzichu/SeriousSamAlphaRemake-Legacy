...
enum BlendControllerType {
  ...
  7 BCT_PULSATING_TEST			    "Pulsating Light Test",        // test
};
    ...
    if (ee.ee_slEvent==EVENTCODE_EActivate)
    {
      switch(m_bctType)
      {
        ...
        case BCT_ACTIVATE_PYRAMID_MORPH_ROOM:
          ...
          break;
        case BCT_PULSATING_TEST:
          pwsc->m_tmPulsatingTest = tmNow;
          pwsc->m_tmPulsatingTestOff = 1e6;
          break;
      }
    }
    else if (ee.ee_slEvent==EVENTCODE_EDeactivate)
    {
      switch(m_bctType)
      {
        ...
        case BCT_ACTIVATE_PLATE_4:
          ...
          break;
		case BCT_PULSATING_TEST:
          pwsc->m_tmPulsatingTestOff = tmNow;
          break;
      }
    }
    return FALSE;
