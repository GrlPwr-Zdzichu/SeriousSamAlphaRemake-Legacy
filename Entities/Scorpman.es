...
functions:
  ...
  INDEX AnimForDamage(FLOAT fDamage) {
    INDEX iAnim;
    switch (IRnd()%3) {
      case 0: iAnim = SCORPMAN_ANIM_WOUND1; break;
      case 1: iAnim = SCORPMAN_ANIM_WOUND3; break;
      case 2: iAnim = SCORPMAN_ANIM_WOUND2; break;
  ...
  void StandingAnim(void) {
    StartModelAnim(SCORPMAN_ANIM_STAND, AOF_LOOPING|AOF_NORESTART);
  };
  void WalkingAnim(void) {
    StartModelAnim(SCORPMAN_ANIM_WALK1, AOF_LOOPING|AOF_NORESTART);
  };
 ...
 ************************************************************/
  ...
  Fire(EVoid) : CEnemyBase::Fire{
    ...
    // to fire
    StartModelAnim(SCORPMAN_ANIM_TOFIRE, 0);
    m_fLockOnEnemyTime = GetModelObject()->GetAnimLength(SCORPMAN_ANIM_TOFIRE) + 0.5f + FRnd()/3;
      ...
      wait(m_fMoveFrequency) {
        on (EBegin) : {
          ...
          if (!IsInPlaneFrustum(m_penEnemy, CosFast(5.0f))) {
            ...
            StartModelAnim(SCORPMAN_ANIM_ATTACK3, AOF_LOOPING|AOF_NORESTART);
          // stand in place
          } else {
            m_fMoveSpeed = 0.0f;
            m_aRotateSpeed = 0.0f;
    ...
    // from fire
    StartModelAnim(SCORPMAN_ANIM_FROMFIRE, 0);
    autowait(GetModelObject()->GetAnimLength(SCORPMAN_ANIM_FROMFIRE));
  ...
  Hit(EVoid) : CEnemyBase::Hit {
    // close attack
    StartModelAnim(SCORPMAN_ANIM_ATTACK4, 0);
    autowait(0.5f);
  ...
  {
    // start sleeping anim
    StartModelAnim(SCORPMAN_ANIM_DEATHREST, AOF_LOOPING);
    // repeat
    wait() {
      // if triggered
  ...
  WakeUp(EVoid)
  {
    // wakeup anim
    SightSound();
    StartModelAnim(SCORPMAN_ANIM_WOUND1, 0);
