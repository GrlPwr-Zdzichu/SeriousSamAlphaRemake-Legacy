...
// ************** STONE PARTS **************
 ...
 // ************** DRAIN COVER **************
 16 model     MODEL_DCOVER1        "Models\\Effects\\Debris\\DrainCover\\Debris1.mdl",
 17 model     MODEL_DCOVER2        "Models\\Effects\\Debris\\DrainCover\\Debris2.mdl",
 18 texture   TEXTURE_DCOVER       "Models\\Ages\\Future\\DrainCover\\DrainCover.tex",
...
functions:
  void Precache(void) {
	...
	case DDT_DCOV:   {  
      PrecacheModel(MODEL_DCOVER1);
	  PrecacheModel(MODEL_DCOVER2);
      PrecacheTexture(TEXTURE_DCOVER);
                          } break;
    }
  };
  ...
  void SpawnDebris(CModelHolder2 *penModel)
  {
    ...
    case DDT_PALM: {
	 ...
	 case DDT_DCOV: {
      Debris_Begin(EIBT_ICE, DPT_NONE, BET_NONE, fEntitySize, penModel->m_vDamage*0.3f, FLOAT3D(0,0,0), 1.0f, 0.0f);
      Debris_Spawn(penModel, this, MODEL_DCOVER1, TEXTURE_DCOVER, 0, 0, 0, 0, fSize,
        FLOAT3D(0.5f, 0.5f, 0.5f));
      Debris_Spawn(penModel, this, MODEL_DCOVER2, TEXTURE_DCOVER, 0, 0, 0, 1, fSize,
        FLOAT3D(0.5f, 0.5f, 0.5f));
	  Debris_Spawn(penModel, this, MODEL_DCOVER1, TEXTURE_DCOVER, 0, 0, 0, 0, fSize,
        FLOAT3D(0.5f, 0.5f, 0.5f));
      Debris_Spawn(penModel, this, MODEL_DCOVER2, TEXTURE_DCOVER, 0, 0, 0, 1, fSize,
