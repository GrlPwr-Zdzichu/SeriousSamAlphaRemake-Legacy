...
// SSA-RM 1.4 Postion Layout (Splited to wpn names,to easier edit thier postions)
// H = Obrót w prawo lub lewo - P = Obrót w górê lub dó³ - B Obrót w prawo lub lewo (Model stoi w miejscu, obraca siê jak opona)
...
wpn_fP[7]=(FLOAT)3.75;
wpn_fB[7]=0;
wpn_fX[7]=(FLOAT)0.210;
wpn_fY[7]=(FLOAT)-0.265;
wpn_fZ[7]=(FLOAT)-0.475;
wpn_fFOV[7]=(FLOAT)75;
wpn_fClip[7]=0.1;
...
wpn_fP[14]=(FLOAT)1;
wpn_fB[14]=0;
wpn_fX[14]=(FLOAT)0.25;
wpn_fY[14]=(FLOAT)-0.28;
wpn_fZ[14]=(FLOAT)-0.56;
wpn_fFOV[14]=(FLOAT)70;
wpn_fClip[14]=0.1;
wpn_fFX[14]=(FLOAT)-0.05;
...
wpn_fP[17]=(FLOAT)6;
wpn_fB[17]=(FLOAT)-0.5;
wpn_fX[17]=(FLOAT)0.155;
wpn_fY[17]=(FLOAT)-0.225;
wpn_fZ[17]=(FLOAT)-0.41;
