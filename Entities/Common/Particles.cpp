...
static CTextureObject _toWaterSpray;
static CTextureObject _toAirIceSpray;
...
void InitParticles(void)
{
  try
  {
    ...
    _toWaterSpray.SetData_t(CTFILENAME("Textures\\Effects\\Particles\\WaterSpray.tex"));
	_toAirIceSpray.SetData_t(CTFILENAME("Textures\\Effects\\Particles\\AirIceSpray.tex"));
	...
	((CTextureData*)_toWaterSpray                     .GetData())->Force(TEX_STATIC);
	((CTextureData*)_toAirIceSpray                     .GetData())->Force(TEX_STATIC);
  }
  catch(char *strError)
  {
...
void CloseParticles(void)
{
  ...
  _toWaterSpray.SetData(NULL);
  _toAirIceSpray.SetData(NULL);
}
                          ...
                          FLOATaabbox3D boxOwner, FLOAT3D vSpilDirection, FLOAT tmStarted, FLOAT fDamagePower)
{
  ...
  switch(sptType) {
	...
	case SPT_WATERSPRAY:
    {
      Particle_PrepareTexture( &_toWaterSpray, PBT_BLEND);
      break;
    }
	case SPT_AIRICESPRAY:
    {
      Particle_PrepareTexture( &_toAirIceSpray, PBT_BLEND);
      break;
    }
    case SPT_FEATHER:
    {
