...
# ADD LINK32 /nologo /subsystem:windows /dll /map /debug /machine:I386 /pdbtype:sept /libpath:"..\\"
...
# ADD LINK32 /nologo /subsystem:windows /dll /map /debug /machine:I386 /out:"Debug/EntitiesD.dll" /pdbtype:sept /libpath:"..\\"
...
# Begin Custom Build
InputPath=.\CyborgBike.es
InputName=CyborgBike
...
SOURCE=.\DevilAlpha.es

!IF  "$(CFG)" == "Entities - Win32 Release"

# Begin Custom Build
InputPath=.\DevilAlpha.es
InputName=DevilAlpha
...
# Begin Custom Build
InputPath=.\RobotDriving.es
InputName=RobotDriving
...
# Begin Custom Build
InputPath=.\RobotFlying.es
InputName=RobotFlying
