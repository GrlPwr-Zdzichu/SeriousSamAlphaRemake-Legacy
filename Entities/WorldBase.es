...
// pulsating
  ...
  pwo->wo_atbTextureBlendings[16].tb_strName         = "Pulsating Light Test";
  pwo->wo_atbTextureBlendings[16].tb_ubBlendingType  = STXF_BLEND_ALPHA;
  pwo->wo_atbTextureBlendings[16].tb_colMultiply     = C_WHITE|CT_OPAQUE;
...
// blendings
  ...
  pwo->wo_attTextureTransformations[16].tt_mdTransformation.md_fUOffset=Sin( tmNow*22)/30;
  pwo->wo_attTextureTransformations[16].tt_mdTransformation.md_fVOffset=Cos( tmNow*26)/35;
  ...
  if( pwsc != NULL)
  {
	...
	// my test
	SetPyramidPlateActivateAlpha(pwo, 16, pwsc->m_tmPulsatingTest, pwsc->m_tmPulsatingTestOff, TRUE);
    // pyramid morph room
