...
#include "Models/Effects/BulletParticles/BulletParticles.h"
...
enum BasicEffectType {
 ...
 42 BET_LAVASTONES          "",     // Lava Planet
 43 BET_BULLETSTAIN          "",     // Lava Planet
};
...
void CBasicEffect_OnPrecache(CDLLEntityClass *pdec, INDEX iUser) 
{
  ...
  case BET_LAVASTONES:
	...
	pdec->PrecacheModel(MODEL_LAVASTONE_FLARE);
    pdec->PrecacheTexture(TEXTURE_LAVASTONE_FLARE);
    break;
  default:
    ASSERT(FALSE);
  }
...
// ********** TELEPORT **********
 ...
 // ********** TELEPORT **********
 61 model   MODEL_LAVASTONE				 "Models\\Effects\\Debris\\Lava01\\Lava.mdl",
 62 texture TEXTURE_LAVASTONE			 "Models\\Effects\\Debris\\Lava01\\Lava.tex",
 63 model   MODEL_LAVASTONE_FLARE        "Models\\Effects\\Debris\\Lava01\\LavaFlare.mdl",
 64 texture TEXTURE_LAVASTONE_FLARE      "Models\\Effects\\Debris\\Lava01\\Flare.tex",
 ...
 ************************************************************/
  ...
  void BulletStain(void) {
  	SetModel(MODEL_BULLET_HIT);
    SetModelMainTexture(TEXTURE_BULLET_HIT);
    CModelObject &mo = *GetModelObject();
    mo.PlayAnim(BULLETPARTICLES_ANIM_DEFAULT_ANIMATION, AOF_NORESTART);
 ...
 ************************************************************/
  ...
  void BulletStainStone(BOOL bSound, BOOL bSmoke)
  {
    if( bSound)
    {
      m_soEffect.Set3DParameters(20.0f, 10.0f, 1.0f, 1.0f+FRnd()*0.07f);
  ...
  void BulletTrail(void) {
    ...
    CModelObject &mo = *GetModelObject();
    mo.PlayAnim( BULLETPARTICLES_ANIM_DEFAULT_ANIMATION, 0);
 ...
 ************************************************************/
  ...
  Main(ESpawnEffect eSpawn)
  {
    ...
    switch (m_betType) {
	  ...
	  case BET_BULLETSTAIN: BulletStain(); break;
      default:
