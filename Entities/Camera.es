...
properties:
  ...
  8 BOOL m_bEpisodicCamera "Episodic Mode" 'E' = FALSE,
 ...
 60 BOOL m_bDisablePlayerControls "Disable Player Contols" 'C' = FALSE,
 61 BOOL m_bDisableHUD "Disable HUD" 'H' = FALSE,
...
functions:
  ...
  void PostMoving()  
  {
   ...
   /*void RenderEpisodicCamera(CDrawPort *pdp)
  {
    CDrawPort dpCamera;
	...
	// Set max ammount of boxes
	CDrawPort adpDrawPorts[1];
	CDrawPort *apdpDrawPorts[1];
	// Make these boxes
	...
	dpLeft.Lock();   dpLeft.Fill( C_BLACK|CT_OPAQUE);  dpLeft.Unlock();
	 adpDrawPorts[1] = CDrawPort( pdp, 0.1666, 0.0, 0.6667, 0.5);
