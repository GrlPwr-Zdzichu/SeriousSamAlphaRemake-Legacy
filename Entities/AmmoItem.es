...
#include "Models/Items/Ammo/HotRocks/Rock.h"
%}
...
// ********* ROCKETS *********
 ...
 21 model   MODEL_RC_ROCKET       "Models\\Items\\Ammo\\Rockets\\Rocket01.mdl",
 22 texture TEXTURE_ROCKET        "Models\\Items\\Ammo\\Rockets\\Rocket01.tex",
 23 texture TEXTURE_HOLDER        "Models\\Items\\Ammo\\Rockets\\Holder.tex",
...
// ********* SERIOUS PACK *********
 ...
 // ********* LAVA ROCKS *********
  80 model   MODEL_ROCKS          "Models\\Items\\Ammo\\HotRocks\\Rock.mdl",
  81 texture TEXTURE_ROCKS        "Models\\Items\\Ammo\\HotRocks\\Rock.tex",

// ********* FUEL RESERVOIR *********
 90 model   MODEL_FL_RESERVOIR          "Models\\Items\\Ammo\\Napalm\\Napalm.mdl",
 91 model   MODEL_FL_1                  "Models\\Items\\Ammo\\Napalm\\1.mdl",
 92 texture TEXTURE_FL_FUELRESERVOIR    "Models\\Weapons\\Flamer\\FuelReservoir.tex",
...
// ************** REFLECTIONS **************
213 texture TEX_REFL_LIGHTMETAL01       "Models\\ReflectionTextures\\LightMetal01.tex",

// ************** SOUNDS **************
214 sound SOUND_PICK             "Sounds\\Items\\Ammo.wav",
215 sound SOUND_DEFAULT          "Sounds\\Default.wav",
...
/*
      ...
      case AIT_NAPALM:
        ...
        break;
	  case AIT_ROCKS:
        pes->es_strName = "Lava rocks"; 
        pes->es_fValue = m_fValue*AV_ROCKS;
        break;
    }
  ...
  void SetProperties(void) {
    switch (m_EaitType) {
      ...
      case AIT_ROCKETS:
        ...
        // set appearance
        AddItem(MODEL_ROCKETS, TEXTURE_HOLDER, 0, 0, 0);
      ...
      case AIT_ELECTRICITY:
        m_fValue = 50.0f;
        m_fRespawnTime = 30.0f;
        m_strDescription.PrintF("Batteries: %d", (int) m_fValue);
        // set appearance
...
/*
      ...
      case AIT_NAPALM:
        ...
        m_fValue = 50.0f;
        m_fRespawnTime = 30.0f;
        m_strDescription.PrintF("Lava rocks: %d", (int) m_fValue);
        // set appearance
        AddItem(MODEL_ROCKS, TEXTURE_ROCKS, TEX_REFL_LIGHTMETAL01, TEX_SPEC_MEDIUM, 0);
        AddFlare(MODEL_FLARE, TEXTURE_FLARE, FLOAT3D(0,0.75f,0), FLOAT3D(3,3,1.0f) );
