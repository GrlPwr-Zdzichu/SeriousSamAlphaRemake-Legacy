...
components:
 ...
 11 texture TEXTURE_WALKER_SOLDIER    "Models\\Enemies\\Walker\\Walker.tex",
 12 texture TEXTURE_WALKER_SERGEANT   "Models\\Enemies\\Walker\\Walker3.tex",
...
functions:
  ...
  {
    DeactivateWalkingSound();
    StartModelAnim(WALKER_ANIM_ATTACK02BOTH, AOF_LOOPING|AOF_NORESTART);
  }
 ...
 ************************************************************/
  Fire(EVoid) : CEnemyBase::Fire {
    ...
    // sergeant 4 rockets
    if (m_EwcChar==WLC_SERGEANT) {
      StartModelAnim(WALKER_ANIM_ATTACK02RIGHT, AOF_LOOPING);
